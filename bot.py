...
def _construire_instruction_annonce(ton_key: str, channel_id, avec_photo: bool) -> str:
    ...
    return (
        ...
        f"{note_photo}"
        "Structure à suivre, inspirée des meilleures annonces Vinted (sans jamais l'afficher explicitement "
        "avec des titres de section, tout doit s'enchaîner naturellement en prose) :\n"
        "1. Une accroche forte en première phrase, qui donne l'info la plus vendeuse en premier (ex: état "
        "neuf, pièce rare, marque recherchée, bon plan) — un acheteur lit en diagonale, il doit comprendre "
        "l'essentiel en 3 secondes. Les meilleurs vendeurs ne présentent jamais l'article, ils balancent "
        "directement ce qui fait la valeur de la pièce.\n"
        "2. Des détails concrets et précis sur le vêtement/objet : coupe, matière, couleur exacte, "
        "particularités visibles (jamais un adjectif vague comme 'de qualité' ou 'confortable' sans "
        "élément concret derrière — préfère une sensation ou un usage réel : 'tissu épais qui tient chaud "
        "l'hiver' plutôt que 'matière de qualité').\n"
        "3. Une idée d'usage ou de contexte qui aide l'acheteur à se projeter (occasion, saison, avec quoi "
        "l'associer), seulement si c'est pertinent et sans que ça sonne artificiel — imagine comment "
        "l'acheteur va réellement porter/utiliser l'objet plutôt que de plaquer une phrase toute faite.\n"
        "4. Une phrase de clôture naturelle et variée (mesures si fournies, état réel en une phrase "
        "honnête, une question courte et spécifique à l'article) — jamais une formule creuse ou un "
        ...
        "c'est vrai et pertinent), sans majuscules excessives ni emoji.\n"
        "- Description : entre 400 et 700 caractères, en phrases fluides, concrètes et vivantes (jamais "
        "une liste de mots-clés recopiés tels quels, jamais de tournure de brochure publicitaire).\n\n"
        ...
        "- Varie la façon de démarrer et de conclure à chaque génération : parfois une observation "
        "concrète, parfois une mise en situation, parfois une question directe posée à l'acheteur — ne "
        "reproduis jamais la même structure de phrase deux fois si on te redemande une version.\n"
